...
--quantity)values ('M335G','Good to use it','Samsung',1222,'Mobile','2024-04-01',true,
--10),('iPhone','User friendly','Apple',1222,'Mobile','2024-04-01',true,
--    100),('S24','Easy to use','Nothing',1222,'Mobile','2024-04-01',true,
--         10),('M24','User interactive','Oppo',1222,'Laptop','2024-04-01',true,
--                      10);
